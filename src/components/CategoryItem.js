        ...
        <React.Fragment>
            <tr className="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <td className="px-4 py-2">
                    <span className=" text-gray-800 text-xs font-medium px-2 py-0.5 dark:bg-orange-900 dark:text-orange-300">{item.content}</span>
                </td>
                <td className="px-4 py-3 gap-1 flex flex-col md:flex-row items-center justify-end">
